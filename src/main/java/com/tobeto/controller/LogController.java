...
public class LogController {
	...
	public GetResponseDTO getEmployee(@RequestBody GetRequestDTO dto) {
		...
		return new GetResponseDTO(employee.getId(), employee.getName(),
	...
	public EditRoleResponseDTO editRole(@RequestBody EditRoleRequestDTO dto) {
		...
		return new EditRoleResponseDTO(previusRole, dto.getRole(),
				dto.getEmail(), employee.getName(), employee.getSurname());
	}

	@PutMapping("/edit/password")
	public EditPasswordResponseDTO editPassword(
			@RequestBody EditPasswordRequestDTO dto) {
		Employee employee = employeeService.updatePassword(dto.getEmail(),
				dto.getPreviousPassword(), dto.getNewPassword());
		String message;
		...
		return new EditPasswordResponseDTO(dto.getPreviousPassword(),
				dto.getNewPassword(), dto.getEmail(), message);
	}
}